                        ...
                        <section className="bg-white" key={index}>
                            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                                <figure className="max-w-screen-md mx-auto">
                                    ...
                                    <blockquote>
                                        <p className="text-2xl font-medium text-gray-900">{review.review_desc}</p>
                                    </blockquote>
                                    <figcaption className="flex items-center justify-center mt-6 space-x-3 flex-col">

                                        <div className="flex items-center divide-x-2 divide-gray-500">
                                            <div className="pr-3 text-md font-medium text-gray-900">{review.created_by.first_name} {review.created_by.last_name}</div>
                                        </div>
