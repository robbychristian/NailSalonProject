...
const NailCustomization = (props) => {
    ...
    const [skinColor, setSkinColor] = useState("#fdc99f");
                    ...
                    <div className="col-span-12 lg:col-span-8 p-6">
                        ...
                        <Container>
                            <Paper variant="outlined" sx={{ marginBottom: "10px" }}>
                                <div className="px-4">
                                    <Typography variant="button">Skin Color Palette</Typography>
                                </div>
                                <div className="flex flex-wrap justify-center items-center p-4">
                                    {skinPalette.map((option) => (
                                        <IconButton variant="outlined"
                                            ...
                                            onClick={() => setSkinColor(option.value)}>
                            ...
                            <Paper variant="outlined">
                                <div className="px-4">
                                    <Typography variant="button">Nail Color Palette</Typography>
                                </div>
                                <div className="flex flex-wrap justify-center items-center p-4">
                                    {colors.map((option) => (
                                        <IconButton variant="outlined"
