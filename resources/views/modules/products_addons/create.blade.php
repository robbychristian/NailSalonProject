...
@section('title', '| Add Product Add Ons')
@section('content')
    <script>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <div class="w-full bg-white rounded-lg shadow md:mt-5 mb-10 md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form action="{{ route('product-add-ons.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" value="{{ old('additional') }}" name="additional" id="additional"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                        @error('additional')
                            <p id="outlined_error_help" class="mt-2 text-xs text-red-600">
                                {{ $message }}</p>
                    ...
                    <div class="mb-6">
                        <label for="additional_price" class="block mb-2 text-sm font-medium text-gray-900">Additional
                            Price</label>
                        <input type="text" value="{{ old('additional_price') }}" name="additional_price"
                            id="additional_price"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
