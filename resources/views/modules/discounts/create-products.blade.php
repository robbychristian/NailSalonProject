    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <div class="w-full bg-white rounded-lg shadow md:mt-5 mb-10 md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form action="{{ route('discounts.products') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea value="{{ old('discount_description') }}" name="discount_description" id="message" rows="4"
                    ...
                    <div class="mb-6">
                        <label for="staff_specialty" class="block mb-2 text-sm font-medium text-gray-900">Products</label>

                        @foreach ($products as $product)
                            <div class="flex items-center mb-4">
                                <input id="default-radio-1" type="radio" value="{{ $product->id }}" name="product"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                <label for="default-radio-1"
                                    class="ms-2 text-sm font-medium text-gray-900">{{ $product->product_name }}</label>
                            </div>
                        @endforeach
