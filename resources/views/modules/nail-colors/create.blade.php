            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form action="{{ route('nail-colors.store') }}" method="post">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="brand" class="block mb-2 text-sm font-medium text-gray-900">Nail Polish
                                Brand</label>
                            <select id="brand" name="brand"
                                ...
                                <option value="Gel polish (Coucou brand)">Gel polish (Coucou brand)</option>
                            </select>
                            @error('brand')
                        ...
                        <div>
                            ...
                            <input type="color" value="{{ old('color') }}" name="color" id="color"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full h-10">
