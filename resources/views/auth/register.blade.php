                                ...
                                <div class="grid grid-cols-12 gap-2">
                                    <div class="col-span-1">
                                        <input type="text" value="+63" readonly disabled
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full py-2.5 px-1.5">
                                    </div>
                                    <div class="col-span-11">
                                        <input type="text" value="{{ old('contact_no') }}" name="contact_no"
                                            id="contact_no" onkeypress="return onlyNumberKey(event)" maxlength="10"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    </div>
                                </div>
